...
export default (props: fontProps) => {
      ...
      onStyleChange([
        {
          ...
          value: formatBgImgUrl(e.target.value),
        },
      ])
  }
  ...
  return (
    <Collapse defaultActiveKey={['0']}>
      <Panel header="背景" key={'0'} className="font-style-container">
        <Row
        ...
        {bgType == 'bgImg' && (
          <Row title={' '} styleKey="" {...props}>
            <Input
              addonAfter={<Icon type="icon-suffix-url" style={{ margin: 4 }} />}
              placeholder="输入图片url"
              style={{ width: '100%' }}
